...
interface PaymentAccountDao : BasicDao<PaymentAccountRecord> {
    ...
    @Query("SELECT COUNT(*) FROM payment_account_record") suspend fun getPaymentRecordCount(): Int

    @Query("SELECT * FROM payment_account_record") suspend fun getAllPaymentRecords(): List<PaymentAccountRecord>
